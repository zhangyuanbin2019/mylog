...
from mylog.forms import SettingForm, PostForm, CategoryForm, LinkForm
from mylog.models import Post, Category, Comment, Link
from mylog.utils import redirect_back, allowed_file
